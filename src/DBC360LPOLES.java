...
public static void main(String[] args) throws IOException, InvalidFormatException {
		...
		System.out.println("DBC360L Prog. V1.0");
	...
	//	FileOutputStream outputFile = new FileOutputStream(new File("C:\\Users\\lg358209sd\\Desktop\\test2.xlsx"));
		...
		while ((line = bufferedReader.readLine()) != null) {	
			...
			String sizeLineF = keyText;
			String sepcat = shortenLine.substring(0, 4);
						
			if(shortenLine.contains(sizeLineF) && sepcat.equals("360L"))
			{				
				 
				
				String cat = line.substring(0,line.indexOf(' '));
				String output = shortenLine.substring(shortenLine.lastIndexOf('P')-1, shortenLine.lastIndexOf('P'));
				temp = (cat+" "+output);
				writer.write(temp);
				writer.newLine();
			}
